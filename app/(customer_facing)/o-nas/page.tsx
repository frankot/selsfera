        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-2 md:items-start">
            ...
            <aside className="md:pl-6">
              {/* Rounded profile photo + caption */}
              <div className="mb-6 flex flex-col items-center">
                <div className="relative h-40 w-40 md:h-[400px] md:w-[400px]">
                  <Image
                    src={BOTTOM_PHOTO}
                ...
                <p className="text-foreground1 mt-4 text-center text-sm font-semibold tracking-wide md:text-base">
